          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-3">
                {[
                  { step: "1", title: "Upload Your Contract", desc: "Drag and drop your .sol files or paste your Solidity code directly into the editor." },
                  { step: "2", title: "Start Analysis", desc: "Click \"Start Analysis\" to begin the automated security scan of your contract." },
                  { step: "3", title: "Review Findings", desc: "Examine the detailed security report with vulnerability descriptions and remediation guides." },
                ].map((item) => (
