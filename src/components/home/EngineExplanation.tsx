...
const EngineExplanation = () => (
  <section className="py-[70px] md:py-[90px] lg:py-[110px] xl:py-[140px]">
    <div className="max-w-[1280px] mx-auto px-5 md:px-8 lg:px-12 xl:px-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5 md:gap-5 mt-10 md:mt-14">
        {features.map((f) => {
          const Icon = f.icon;
          return (
            <div
              key={f.title}
              className="rounded-xl md:rounded-2xl border border-border/20 bg-card/20 p-[18px] md:p-7 hover:border-primary/20 transition-colors"
            >
