...
const DifferentiatorComparison = () => (
  <section className="py-[70px] md:py-[90px] lg:py-[110px] xl:py-[140px]">
    <div className="max-w-[1280px] mx-auto px-5 md:px-8 lg:px-12 xl:px-20">
      <h2 className="text-[clamp(1.6rem,5vw,5.5rem)] font-black tracking-tight leading-[1.15] text-center max-w-4xl mx-auto">
        Most scanners check contracts. Solarizer models the entire protocol.
      </h2>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-6 mt-10 md:mt-14 max-w-4xl mx-auto">
        {/* Traditional */}
        ...
        {/* Solarizer */}
        <div className="rounded-[14px] md:rounded-[16px] border border-primary/20 bg-card/20 p-5 md:p-7 md:p-7">
