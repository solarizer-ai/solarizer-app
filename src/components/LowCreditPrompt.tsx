...
export function LowCreditPrompt({ creditsRemaining, onPurchase, isTrial, onSubscribe }: LowCreditPromptProps) {
  ...
  return (
    <div className="relative p-4 rounded-lg border border-amber-500/30 bg-amber-500/5">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 pr-8">
        ...
        {isTrial ? (
          <Button size="sm" onClick={onSubscribe} className="gap-2 flex-shrink-0">
