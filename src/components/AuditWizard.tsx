...
interface AuditWizardProps {
  onComplete: (data: { projectName: string; files: FileNode[]; code: string }) => void;
  onCancel: () => void;
  isSubmitting?: boolean;
}

type WizardStep = 'name' | 'method' | 'input';
...
const AuditWizard = ({ onComplete, onCancel, isSubmitting = false }: AuditWizardProps) => {
