      ...
      >
        <AccordionTrigger className={cn("px-3 md:px-4 py-2 md:py-3 hover:no-underline", hoverClass)}>
          <div className="flex items-center gap-2 md:gap-3 text-left flex-1 min-w-0">
            ...
            <p className="text-xs md:text-sm font-medium text-foreground line-clamp-2 md:truncate flex-1 min-w-0">
              {test.test_name}
            </p>
          </div>
        </AccordionTrigger>
        ...
        <div className={cn(
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-3 md:gap-4">
            <div className="flex items-center gap-2 md:gap-3 shrink-0">
              ...
              <span className={cn("text-2xl md:text-3xl font-bold", shieldConfig.color)}>
              ...
              >
                <AccordionTrigger className={cn(
                  ...
                  <div className="flex items-center gap-2 md:gap-3 text-left flex-1 min-w-0">
                    ...
                    <span className={cn(
                      "text-sm md:text-lg font-bold px-2 md:px-3 shrink-0",
                      groupPassPercentage === 100 ? "text-success" : hasFailures ? "text-destructive" : "text-foreground"
                    )}>
