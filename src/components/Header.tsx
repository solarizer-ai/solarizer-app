  ...
  return (
    <>
      ...
      <header className="fixed top-4 left-1/2 -translate-x-1/2 z-[60] max-w-2xl w-[calc(100%-2rem)]">
        <div className="rounded-2xl bg-black/60 backdrop-blur-xl border border-primary/40 shadow-[0_0_30px_rgba(0,0,0,0.3)] px-4 h-12 flex items-center justify-between">
          {/* Left: Logo + Brand */}
